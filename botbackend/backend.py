import keyboard
from tkinter import *
from model_processor_synonym import start_listening, setup_model
...
# GUI
wordCorpus, outputClasses, inputModel = setup_model()
root = Tk()
root.title("Chatbot")
...
def process_text(user):
    response = start_listening(user, words=wordCorpus, outputClasses=outputClasses, inputModel=inputModel)
    txt.insert(END, "\n" + response)
    '''
    if (user == "hello"):
